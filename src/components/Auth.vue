      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <div class="flex justify-between items-center pb-4">
            ...
            <!-- Modal Close Button -->
            <div class="modal-close cursor-pointer z-50" v-on:click.prevent="toggleAuthModal">
          ...
          <ul class="flex flex-wrap mb-4">
            ...
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition" 
                href="#" v-on:click.prevent="tab = 'register'"
                v-bind:class="{
          ...
          <!-- Registration Form -->
          <vee-form v-show="tab=='register'" v-bind:validation-schema="schema" v-bind:initial-values="userData"
